...
export const procurementAPI = {
  ...
  confirmPayment: (id: string) => api.put(`/procurement/requests/${id}/confirm-payment`),
  markCashPaid: (id: string) => api.put(`/procurement/requests/${id}/cash-paid`),
  takeInWork: (id: string) => api.put(`/procurement/requests/${id}/take-work`),
  markReady: (id: string) => api.put(`/procurement/requests/${id}/ready`),
  ship: (id: string) => api.put(`/procurement/requests/${id}/ship`),
  productionReady: (id: string) => api.put(`/procurement/requests/${id}/production-ready`),
  cancelRequest: (id: string, note?: string) => api.put(`/procurement/requests/${id}/cancel`, { note }),
